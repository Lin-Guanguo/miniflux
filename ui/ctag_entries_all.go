...
func (h *handler) showCTagEntriesAllPage(w http.ResponseWriter, r *http.Request) {
	...
	view.Set("pagination", getPagination(route.Path(h.router, "ctagEntriesAll", "ctagID", ctag.ID), count, offset, user.EntriesPerPage))
	view.Set("menu", "ctags")
	view.Set("user", user)
